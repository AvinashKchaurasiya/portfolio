...
@section('content')
    ...
    <div id="mainContent" class="main">
        <h3 class="mb-2">Edit Education</h3>

        <div class="row g-4">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5>Edit Education Form</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" id="course" name="course" class="form-control" required
                                        value="{{ old('course', $education->cource) }}" />
                                ...
                                <div class="form-outline mb-4">
                                    <input type="text" id="specialization" name="specialization" class="form-control"
                                        required value="{{ old('specialization', $education->specialization) }}" />
                                    <label class="form-label" for="specialization">Specialization</label>
                                </div>

                                {{-- College Name --}}
                                <div class="form-outline mb-4">
                                    <input type="text" id="collegeName" name="college_name" class="form-control" required
                                        value="{{ old('college_name', $education->collage_name) }}" />
                                ...
                                <div class="form-outline mb-4" id="toDateContainer"
                                    @if (old('currently_study', $education->currently_study)) style="display:none;" @endif>
                                ...
                                <div class="form-check mb-4">
                                    <input type="checkbox" id="currentlyStudy" name="currently_study"
                                        ...
                                        {{ old('currently_study', $education->currently_study) ? 'checked' : '' }} />
                                ...
                                <div class="form-outline mb-4">
                                    <textarea class="form-control" id="miniProjectDescription" name="mini_project_description" rows="3">{{ old('mini_project_description', $education->mini_project) }}</textarea>
                                    <label class="form-label" for="miniProjectDescription">Mini Project Description</label>
                                </div>

                                {{-- Major Description --}}
                                <div class="form-outline mb-4">
                                    <textarea class="form-control" id="majorDescription" name="major_description" rows="3">{{ old('major_description', $education->major_project) }}</textarea>
